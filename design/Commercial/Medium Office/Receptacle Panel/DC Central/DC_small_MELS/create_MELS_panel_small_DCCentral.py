...
for ckts in ckt_lp:
    ...
    for x in range(0, row_cnt):
        ...
        eline8 = ("  connect(" + str(ckts) + ".p2, cable_MEL_" + mel_name + ".n);\n")
    ...
    mline02 = ("  HPF.DC.DC2DC_Converters.StepDown " + str(ckts) + "(modelData = modelData_DCDC);\n")
    mline03 = ("  HPF.Cables.NEC_CableModelDC cable_" + str(ckts) + 
              "(wireGaugeDC = HPF.Types.WireGaugeDC.gauge_12, length=" + str(m) 
              + ");\n")     
    ...
    ## Modelica code syntax to add "equation" information
    eline01 = ("\n/* DC/DC Converter " + str(ckts) +" */\n")
    eline02 = ("  connect(cable_" + str(ckts) + ".n," + cable_name + ".p);\n")
    eline03 = ("  connect(" + str(ckts) + ".p1,  cable_" + str(ckts) + ".p);\n")
    eline04 = ("  connect(" + str(ckts) + ".n1, GndDC.p);\n")
    eline05 = ("  connect(" + str(ckts) + ".n2, GndDC.p);\n")
