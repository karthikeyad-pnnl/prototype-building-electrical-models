...
# #Median Model - Mean-Well-RSD-30G-12-12V
# lgt_driv_alpha = 0.009351348
# lgt_driv_beta = 0.125262
# lgt_driv_gamma = 0.06032826
# lgt_driv_stndby = 0.26452
...
for data1 in df_ckt_lgt:
    ...
    for data in df_ckt_lgt1:
        ...
        eline8 = ("  connect(" + str(data1) + ".pin_p, cable_light_" + str(data) + ".n);\n")
    ...
    mline02 = ("  HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple " 
             + str(data1) + "(P_DCmin=0, VAC_nom=277,VDC_nom=48" 
             + ",P_nom=360" + line3c + ");\n")
    mline03 = ("  HPF.Cables.NEC_CableModel cable_" + str(data1) + 
    ...
    ## Modelica code syntax to add "equation" information
    eline01 = ("\n/* AC/DC Converter " + str(data1) +" */\n")
    eline02 = ("  connect(cable_" + str(data1) + ".pin_n, cable_light_" + new_ckt + ".pin_p);\n")
    eline03 = ("  connect(" + str(data1) + ".hPin_L,  cable_" + str(data1) + ".pin_p);\n")
    eline04 = ("  connect(" + str(data1) + ".hPin_N, GndAC.pin);\n")
    eline05 = ("  connect(" + str(data1) + ".pin_n, GndDC.p);\n")
